...
SITE_IDENTIFIER = 'illimite_streaming' #identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = 'illimite_streaming' #nom que xbmc affiche
SITE_DESC = 'illimite_streaming' #description courte de votre source

URL_MAIN = 'https://vvw.illimitestreaming.net' #url de votre source
